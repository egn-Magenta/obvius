...
Obvius::CatalystUtils - Catalyst based application

=head1 SYNOPSIS

    script/obvius_catalystutils_server.pl
...
L<Obvius::CatalystUtils::Controller::Root>, L<Catalyst>
