...
function obvius_tinymce_new_navigator_callback(field_name, url, type, win, window_callback) {
  return obvius_tinymce_navigator_callback_p(field_name, url, type, 'obvius_app_navigator=1', 'width=700, height=432, status=yes, scrollbars=1, resizable=1', win, window_callback); /* See mason/admin/portal/util/navigator_link_start */
}

function obvius_tinymce_navigator_callback_p(field_name, url, type, arg, options, win, window_callback) {
  ...
  var url = "/admin" + uri + obvius_navigator_argument;
