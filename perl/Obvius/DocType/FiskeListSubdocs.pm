package Obvius::DocType::FiskeListSubdocs;

########################################################################
#
# FiskeListSubdocs.pm - FiskeListSubdocs Document Type
#
...
Obvius::DocType::FiskeListSubdocs - Perl extension for blah blah blah

=head1 SYNOPSIS

  use Obvius::DocType::FiskeListSubdocs;
  blah blah blah

=head1 DESCRIPTION

Stub documentation for Obvius::DocType::FiskeListSubdocs, created by h2xs. It looks like the
