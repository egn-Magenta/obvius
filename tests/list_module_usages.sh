...
EXCLUDE_MODULES="Apache2::SizeLimit|Apache2::compat|Apache::File|Text::Format|Text::Aspell|XML::DOM|WebObvius::Cache::Flushing|WebObvius::FormEngine::Fields::MultipleBase|WebObvius::Site|use mysql;|use strict;|use warnings;|use utf8;"
